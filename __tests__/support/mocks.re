...
module Rest = {
  ...
  let post =
    rest
    |> post("https://api.github.com/repos/:owner/:repo", (req, res, ctx) => {
         let body =
           Printf.sprintf(
             "%s/%s",
             req.params
  ...
  let put =
    rest
    |> put("https://api.github.com/repos/:owner/:repo", (req, res, ctx) => {
         let body =
           Printf.sprintf(
             "%s/%s",
             req.params
  ...
  let patch =
    rest
    |> patch("https://api.github.com/repos/:owner/:repo", (req, res, ctx) => {
         let body =
           Printf.sprintf(
             "%s/%s",
             req.params
  ...
  let delete =
    rest
    |> delete("https://api.github.com/repos/:owner/:repo", (req, res, ctx) => {
         let body =
           Printf.sprintf(
             "%s/%s",
             req.params
  ...
  let options =
    rest
    |> options("https://api.github.com/repos/:owner/:repo", (req, res, ctx) => {
         let body =
           Printf.sprintf(
             "%s/%s",
             req.params
  ...
  let mutationError =
    ...
    |> mutation("LogoutError", (req, res, ctx) => {
         let message = (
           "message",
           Js.Json.string(
             "This is a mocked error: " ++ req.variables##referrer,
           ),
         );
         let location =
           Js.Dict.fromList([
